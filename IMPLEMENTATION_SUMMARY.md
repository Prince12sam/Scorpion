...
- **After:** `ports: str = "1-10000"`
- **Impact:** 10x more ports scanned by default (1-10000 vs 1-1024)
...
|------------------|-----------------|
| `scorpion scan -t target` | `nmap -p1-10000 --open target` |
| `scorpion scan -t target --show-all` | `nmap -p1-10000 target` |
| `scorpion scan -t target --fast` | `nmap -T4 -p1-10000 --open target` |
...
|--------|-------------|-------------|-------------|
| **Port Coverage** | 1-1024 | 1-10000 | 10x more ports |
...
- 10x port coverage (1-10000 vs 1-1024)
